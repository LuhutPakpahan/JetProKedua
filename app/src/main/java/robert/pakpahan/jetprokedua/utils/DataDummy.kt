...
import robert.pakpahan.jetprokedua.source.remote.response.movie.*
import robert.pakpahan.jetprokedua.source.remote.response.movie.Genre
import robert.pakpahan.jetprokedua.source.remote.response.movie.ProductionCompany
import robert.pakpahan.jetprokedua.source.remote.response.movie.ProductionCountry
import robert.pakpahan.jetprokedua.source.remote.response.movie.SpokenLanguage
import robert.pakpahan.jetprokedua.source.remote.response.tvshow.*

typealias TvShowGenre = robert.pakpahan.jetprokedua.source.remote.response.tvshow.Genre
typealias TvShowProductionCompany = robert.pakpahan.jetprokedua.source.remote.response.tvshow.ProductionCompany
typealias TvShowProductionCountry = robert.pakpahan.jetprokedua.source.remote.response.tvshow.ProductionCountry
typealias TvShowSpokenLanguage = robert.pakpahan.jetprokedua.source.remote.response.tvshow.SpokenLanguage
